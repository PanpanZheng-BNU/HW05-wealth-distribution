...
# ╔═╡ 989a6fb6-82fa-11ee-192a-1f6f0e3a734a
using CSV, DataFrames, CairoMakie, StatsBase

# ╔═╡ 9e9a5c7a-0260-4031-ba49-e9281d22a790
md"""
# Plot result
...
# ╔═╡ b1b5bb81-7737-449a-a333-b20f438f45d5
md"""
### import data
...
# ╔═╡ edf877e0-e83a-4f05-9b97-f788ad1b9f82
begin
...
# ╔═╡ 056b3106-d04e-4a55-81b8-5b93975b5150
md"""
...
# ╔═╡ 8f0cb29a-0234-4b1f-bd38-70b621667a06
...
# ╔═╡ 2f6d4cc1-7cf5-4e8b-8426-176e47a6efbb
...
# ╔═╡ 27a9fe7e-e3f8-4c18-aeff-d40dac20baba
md"""
- convert raw data to average probability denstiy and store this result to `result`
"""

# ╔═╡ 9097d038-0cd5-47df-8e2f-14c7c4f66f7a
result1000 = m2pd_all(m_all1000, ps = 10 .^ (-3:0.0025:3));

# ╔═╡ 4aa2cbab-6447-4579-a954-e1f69c352c76
md"""
### Ploting
- draw the average probability density result we get in `result`
"""

# ╔═╡ 273b5caf-76ab-4842-a2e0-a477aca9d020
begin
	fig::Figure = Figure()
	ax::Axis = Axis(
		fig[1,1],
...
# ╔═╡ 509e5065-9527-4ccc-aebc-5e51055484b1
save("/tmp/t.svg",fig)

# ╔═╡ d511c659-11a9-4681-9874-9b84ac688af6
md"""
### import data about lambda
"""

# ╔═╡ 0446da3f-18f2-4fbe-b04b-2e6a89053a64
begin
...
# ╔═╡ 269f8c92-261a-42d4-8317-82e60d2dc870
begin
...
# ╔═╡ 01143081-220b-4555-973c-d6b9ea769527
begin
...
# ╔═╡ 1a4c8113-4d0f-4ef3-8d54-b335ec8b1800
begin
	fig2 = Figure()
	ax2 = Axis(
		fig2[1,1],
...
# ╔═╡ 7fb3582f-26ea-4754-89c7-1f73c66c2089
save("/tmp/t.svg",fig2)

# ╔═╡ 09654f5c-c90e-4197-8be4-c11aceeb0f26
md"""
## Import data from N100
> This section describe the distribution of the wealth when the $\lambda$ is not uniform
"""

# ╔═╡ 7bacc135-4bf8-4cb8-9d8a-1408ab4c3559
path2N100 = "../data/N100/";

# ╔═╡ 3d408643-bfe3-4884-b13f-ca2a2f14a00b
begin
	reg_alpha = r"^alpha*"
	reg_u = r"^u[0-9]{2}"
...
# ╔═╡ 3be46a48-8a0c-4f3d-92bd-709a88662280
begin
...
# ╔═╡ 6b3fe189-64a8-40b3-b3ff-650aaf919f7d
begin
	x = [0:0.01:1...]
	fig3 = Figure()
...
# ╔═╡ 76ca39a9-08d4-4cbe-8df6-7ea18d7827c6
save("/tmp/t.svg",fig3)

# ╔═╡ 626a04d7-2b85-4c4c-b830-c56d1eaf0715
begin
	ps = 10 .^ (-2:0.005:2)
...
# ╔═╡ 36ce3d4a-eb64-4139-b5e1-f31af9a0c322
begin
	fig4::Figure = Figure()
	ax41::Axis = Axis(
		fig4[1,1],
...
# ╔═╡ 0324194f-5f11-42df-a067-9dea5786ed48
save("/tmp/t.svg",fig4)

# ╔═╡ 435fe2cc-0ce7-4cc1-8f8d-f0aefcc32f3f
begin
	ps2 = 10 .^ (-2:0.0025:2)
...
# ╔═╡ 8caab2a7-10d8-4abb-be96-6ddc4393af35
begin
...
# ╔═╡ 30e4363f-233d-4e6b-a59b-d1649679b637
save("/tmp/t.svg", fig5)
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "7fb8ca0871b933d6df8befbfe1497e7c0b8dfb8c"
